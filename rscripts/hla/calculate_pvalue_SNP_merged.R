...
merged = read.delim("/ceph/CPHG/T1DGC/USERS/dam8mt/data/MEGA/HLA/association_analysis_merged/all/assoc_logistic_chr6_SNP_merged.txt", colClasses = c(A1 = "character"))
merged_freq <- read.delim("/ceph/CPHG/T1DGC/USERS/dam8mt/data/MEGA/HLA/association_analysis_merged/all/assoc_logistic_chr6_SNP_merged_freq.txt", colClasses = c(A1 = "character", A2 = "character"))
...
write.table(merged, file = "/ceph/CPHG/T1DGC/USERS/dam8mt/data/MEGA/HLA/association_analysis_merged/all/assoc_logistic_chr6_SNP_merged_p.txt", row.names = F, sep = "\t", quote = F)
write.table(merged_freq, file = "/ceph/CPHG/T1DGC/USERS/dam8mt/data/MEGA/HLA/association_analysis_merged/all/assoc_logistic_chr6_SNP_merged_freq_p.txt", row.names = F, sep = "\t", quote = F)
