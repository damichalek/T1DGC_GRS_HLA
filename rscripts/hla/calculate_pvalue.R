...
EUR <- read.delim("/ceph/CPHG/T1DGC/USERS/dam8mt/data/MEGA/HLA/association_analysis/Temp/assoc_logistic_chr6_EUR.txt", colClasses = c(A1 = "character"))
...
write.table(EUR, file = "/ceph/CPHG/T1DGC/USERS/dam8mt/data/MEGA/HLA/association_analysis/Temp/assoc_logistic_chr6_EUR_p.txt", row.names = F, sep = "\t", quote = F)
